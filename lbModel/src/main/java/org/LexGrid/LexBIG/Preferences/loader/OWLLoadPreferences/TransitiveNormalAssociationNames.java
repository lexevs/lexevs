...
/**
 * Class TransitiveNormalAssociationNames.
 * 
 * @version $Revision$ $Date$
 */
@SuppressWarnings("serial")
public class TransitiveNormalAssociationNames implements java.io.Serializable {
     ...
     *  be the transitive relation, with association direction
     * going the opposite of it's inverse
     *  relation.
     *  
     */
    ...
    public TransitiveNormalAssociationNames() {
        super();

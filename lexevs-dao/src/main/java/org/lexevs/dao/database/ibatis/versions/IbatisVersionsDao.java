...
public class IbatisVersionsDao extends AbstractIbatisDao implements VersionsDao {
	...
	public void insertEntryState(
		...
		Assert.state(entryType != null,"entryType cannot be null");
		Assert.state(
	...
	public void insertEntryStateMybatisBatch(
		...
		Assert.state(bean.getEntryType() != null,"bean.getEntryType() cannot be null");
		Assert.state(
	...
	public void deleteAllEntryStateEntriesByEntryUId(String codingSchemeUId,
			String entryUId) {
		Assert.notNull(entryUId,"entryUId is null");
